...
namespace Punto3
{
    class diasFaltas
    {
        ...
        public void faltoMenos()
        {
            menos = diasFaltados[0].Length;

            for (int i = 0; i < diasFaltados.Length; i++)
            {
                if (diasFaltados[i].Length < menos)
                {
        ...
        public void imprimir()
        {
            ...
            for (int i = 0; i < nombres.Length; i++)
            {
                Console.WriteLine($"Empleado: {nombres[i]} / Faltas: {diasFaltados[i].Length}");
            ...
            Console.WriteLine($"\n{nombres[menosPos]} falto menos ({menos} falta/s)");
        }
