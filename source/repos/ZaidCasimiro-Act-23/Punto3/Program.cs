...
namespace Punto3
{
    class MonitoreoCostero
    {
        ...
        public void CargarAvistamientos()
        {
            ...
            do
            {
                Console.Write("Ingrese especie avistada (o FIN para terminar): ");
        ...
        public void MostrarReporteOrdenado()
        {
            ...
            Console.WriteLine("Reporte ordenado A-Z");
        ...
        public void MostrarReporteInvertido()
        {
            ...
            Console.WriteLine("-Reporte ordenado Z-A");
            foreach (string e in especiesDetectadas)
            {
                Console.WriteLine(e);
            }
        ...
        public void BuscarEspecie()
        {
            ...
            if (especiesDetectadas.Contains(buscada))
            {
                Console.WriteLine($"{buscada} fue divisada en la costa hoy.");
            }
            else
            {
                Console.WriteLine($"{buscada} no fue divisada en la costa hoy.");
            }
        }
        class Program
        {
